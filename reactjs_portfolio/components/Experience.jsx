function Experience() {
  return (
    <div className="experience text-center p-5 lg:p-32 gap-5 lg:gap-10 " id="experience">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 space-y-10 lg:space-y-0 lg:space-x-10 py-10">
        <div className="ring-1 p-10 rounded-3xl py-20">
          <div className="text-gray-900 p text-3xl font-bold">Frontend Development</div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3">
            <div className="flex py-5">
              ...
              <div className="flex flex-col justify-center items-start">
                ...
                <div className="text-gray-600 text-md font-semibold">Experience</div>
              </div>
            </div>
            <div className="flex py-5">
              <img src="/checkmark.png" className="h-10" />
            ...
            <div className="flex py-5">
              ...
              <div className="flex flex-col justify-center items-start">
                ...
                <div className="text-gray-600 text-md font-semibold">Intermediate</div>
              </div>
            </div>
            <div className="flex py-5">
              <img src="/checkmark.png" className="h-10" />
        ...
        <div className="ring-1 p-10 rounded-3xl py-20">
          <div className="text-gray-900 text-3xl font-bold">Backend Development</div>
          <div className="grid grid-cols-2 lg:grid-cols-3">
            <div className="flex py-5">
              <img src="/checkmark.png" className="h-10" />
              <div className="flex flex-col justify-center items-start">
            ...
            <div className="flex py-5">
              <img src="/checkmark.png" className="h-10" />
              <div className="flex flex-col justify-center items-start">
                <div className="text-gray-900 text-md font-bold">Larravel</div>
                <div className="text-gray-600 text-md font-semibold">Intermediate</div>
              </div>
            </div>
